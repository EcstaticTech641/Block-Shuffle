...
### Added
- **RGA Event API Integration**: Integrated `com.ronlab:rga-api:1.10.1` for event-driven session lifecycle management (`MinigameStartEvent` and `MinigameConcludeEvent`).
